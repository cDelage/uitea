...
function ThemeCustomizerComponent() {
  const { activePalette } = useThemeCustomizerContext();
  ...
  return (
    <>
      ...
      <SidePanel.BodyRelative id="palette-customizer" width="500px" isOpenToSync={isSidepanelOpen} setIsOpenToSync={setIsSidepanelOpen}>
        {activePalette &&
          <ThemePaletteSidepanel activePalette={activePalette} />
        }
