import { cloneElement, JSX, MouseEvent, ReactElement, ReactNode, useContext, useState } from "react";
import { useDivClickOutside } from "../../util/useDivClickOutside";
import { createPortal } from "react-dom";
import styles from "./Modal.module.css"
import { ModalContext, ModalContextType } from "./useModalContext";
...
function Toggle({ children, id }: { children: ReactNode; id: string }) {
  ...
  return cloneElement(children as ReactElement<{ onClick?: () => void }>, { onClick: () => open(id) });
}
